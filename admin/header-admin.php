...
include "../ecommerce_site/web_config_vars.php";
// *** DB CONNECTION
...
if (!empty($_POST['username'])){
   ...
   $check=@mysqli_num_rows(@mysqli_query($conn,"SELECT username,password FROM admin_web WHERE username='". $_POST['username'] ."' AND password='". $password_md5 ."'"));
   //echo "[ $check ]";
   if ($check>0){
...
<ul>
	<li><a href="index.php">Beranda</a></li>
		<li><a href="tambah_kategori.php">Kategori</a></li>
         ...
         <li><a href="tambah_anggota.php">Anggota</a></li>
