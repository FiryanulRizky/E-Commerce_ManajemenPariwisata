...
if ($_POST['act']=="add"){
    @mysqli_query($conn,"INSERT INTO produk(category,nama_produk,deskripsi,harga,stok) VALUES ("
    ."'".$_POST['category']."','".$_POST['name']."','".$_POST['description']."','".$_POST['price']."','".$_POST['stok']."')");

if( !empty($_FILES['gambar']['name']) )
    {
    $path = "../items/";
    $lastid=@mysqli_result(@mysqli_query($conn,"SELECT id_produk FROM produk ORDER BY id_produk DESC LIMIT 0,1"),0,0);
