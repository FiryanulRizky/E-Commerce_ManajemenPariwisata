...
$hasil=mysqli_query($conn,"INSERT into admin_web(username,password,nama,telepon,jabatan)
...
<option>User</option>
    ...
    <?php
    $result = mysqli_query($conn,"SELECT * FROM admin_web");

    echo"

    <table border='1'  cellspacing='0' cellpadding='0'>
    <tr><td colspan=7><h3 align='center'>Data Admin</h3></td></tr>
    ...
    while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
        {
             ...
             echo "<td><a href=\"hapus_admin.php?id=".$row['id_admin']."\"> <i class='fa fa-eraser' style='font-size: 20px;'></i></a><td>";
             echo"</tr>";
