...
mysqli_query($conn,"UPDATE produk SET views = views + 1  WHERE id_produk='".$_GET['id_barang']."'");

// QUERY TABLE php_shop_products n record per page
//echo $sql;
$result = mysqli_query($conn,"SELECT * FROM produk WHERE id_produk='".$_GET['id_barang']."'");
