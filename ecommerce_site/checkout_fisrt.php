    ...
    $checkout_cnt.= "<tr>
       ...
       // LOOPING / PENGULANGAN : UNTUK MENDEFINISIKAN ISI KERANJANG
        ...
        <img src=\"items/".$product_id.".jpg\" width=80 height=90 align=center border=1px </a>";
            ...
            $result = mysqli_query($conn,"SELECT id_produk, nama_produk, deskripsi, harga, stok FROM produk WHERE id_produk = $product_id");
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                // MENGHITUNG TOTAL JUMLAH ($quantity)
                 $total_quantity += $quantity;
                  ...
                  $result = mysqli_query($conn,"SELECT * FROM ukuran");
