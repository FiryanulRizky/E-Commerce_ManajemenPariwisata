...
// *** SWITCH ACTION
'echo<div id="tbcart">';
$conn = mysqli_connect("localhost","root","") or die("can not access database");
mysqli_select_db("phpshop",$conn) or die("can not connect");
...
if($_SESSION['cart']) {	// *** JIKA KERANJANG ADA ISI NYA / TIDAK KOSONG
    ...
    echo '<tr><td colspan=4><h1>Cart</h1></td></tr>';
        ...
        foreach($_SESSION['cart'] as $product_id => $quantity) {
            ...
            $result = mysqli_query($conn,"SELECT name, description, price FROM php_shop_products WHERE id = $product_id");
